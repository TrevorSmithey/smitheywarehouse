              ...
              {isExpanded && (
                <div className="border-t border-border">
                  <table className="w-full text-sm table-fixed">
                    ...
                    <thead>
                      <tr className="border-b border-border/50 text-sm bg-bg-tertiary/30">
                        <th className="text-left py-2.5 px-2 sm:px-3 font-medium text-text-primary">Product</th>
                        ...
                        <th className="text-right py-2.5 px-2 sm:px-4 font-medium text-text-primary">
